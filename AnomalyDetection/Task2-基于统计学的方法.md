...
相关算法：COPOD，可参考https://zhuanlan.zhihu.com/p/338189299
...
在许多情况下假定数据是由正态分布产生的。当实际数据很复杂时，这种假定过于简单，可以假定数据是由混合参数分布产生的。

关于混合参数分布，可参考https://blog.csdn.net/chikily_yongfeng/article/details/105750861
