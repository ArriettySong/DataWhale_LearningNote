...
为了解决这些问题，我们必须将各种情况分开讨论，然后给出评价指标。             
   ...
   - 假阴性FN（False Negative）：预测值为负，实际值为正；![jupyter](./1.22.png)
...
​    https://scikit-learn.org/stable/modules/model_evaluation.html#classification-metrics![jupyter](./1.21.png)      
